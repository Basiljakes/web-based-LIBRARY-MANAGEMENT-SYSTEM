...
<body>
            ...
            <div class="reg_area">
                ...
                <form name="Registration" action="" method="post">                    
                    <div class="reg_form" style="text-color: black;">
                        ...
                        <input type="text" name="contact" placeholder="enter User contact" required=""><br><br>
    ...
    <?php
        if(isset($_POST['submit']))
        {
            ...
            {
                mysqli_query
                ($db,"INSERT INTO `admin` VALUES('', '$_POST[firstname]', '$_POST[lastname]', '$_POST[email]', '$_POST[username]', '$_POST[password]', '$_POST[contact]', 'contact1.jpg');");
                ?>
                <script type="text/javascript">
                    alert("Nice! your Registration is successful");
                </script>        
                <?php
            }
           else
