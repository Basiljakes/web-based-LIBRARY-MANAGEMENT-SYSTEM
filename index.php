    ...
    <div class="checker">
        ...
        <section>
            <div class="sec_image">
                ...
                <div class="open">
                    <br><br><br>
                    <h1 style="text-align: center; font-size: 60px;">WELCOME TO GOSHEN LIBRARY</h1><br><br>
                    <h1 style="text-align: center; font-size: 40px">Opens at 8:00am</h1><br>
                    <h1 style="text-align: center; font-size: 40px">Closes at 6:00pm</h1><br>

                </div>
            </div>
        </section>
        <footer>
            <p style="color: white; text-align: center; font-size: x-larg;">&copy; 2025 Goshen Online Library Management System <br>
                Email: &nbsp; &nbsp;GoshenOLMS@gmil.com <br>
                Mobile: &nbsp; &nbsp;&nbsp; &nbsp;+447234456789 <br>
            </p>
            <br>
